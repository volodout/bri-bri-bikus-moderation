...
class ProductEventTestCase(unittest.TestCase):
    ...
    def event(self, event_type: str = "CREATED", event_date: str = "2026-03-15T14:30:00.000Z") -> dict:
        return {
    ...
    def test_created_event_fetches_product_and_creates_pending_moderation_record(self) -> None:
        service, client = self.service()

        result = service.handle(self.event("CREATED"))

        self.assertEqual({"status": "accepted"}, result.as_json())
        self.assertEqual([PRODUCT_ID], client.calls)
    ...
    def test_duplicate_created_event_is_business_error(self) -> None:
        ...
        service.handle(self.event("CREATED", "2026-03-15T14:30:00.000Z"))

        with self.assertRaises(BusinessError):
            service.handle(self.event("CREATED", "2026-03-15T14:31:00.000Z"))
    ...
    def test_edited_event_requeues_blocked_product_and_clears_field_reports(self) -> None:
        ...
        service.handle(self.event("EDITED", "2026-03-16T09:00:00.000Z"))
    ...
    def test_deleted_event_removes_record_and_is_idempotent_when_missing(self) -> None:
        ...
        service.handle(self.event("DELETED", "2026-03-16T09:00:00.000Z"))
        service.handle(self.event("DELETED", "2026-03-16T09:01:00.000Z"))
...
class HttpProductEventTestCase(unittest.TestCase):
    def test_invalid_service_key_returns_401(self) -> None:
        ...
        body = json.dumps({"event": "CREATED"}).encode("utf-8")
